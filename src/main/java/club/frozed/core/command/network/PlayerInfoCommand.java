...
public class PlayerInfoCommand extends BaseCMD {
    ...
    public void onCommand(CommandArgs command) {
        ...
        playerData.getPermissions().forEach(perm -> playerPerms.add(CC.translate("&b" + perm)));
        showPermsList.add(CC.translate("&8 ► &7Permissions&f: &e" + playerData.getPermissions().size()), StringUtils.join(playerPerms, "\n"), null);
