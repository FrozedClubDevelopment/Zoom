...
import club.frozed.core.utils.license.License;
import club.frozed.core.utils.license.WB;
...
public final class Zoom extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        License license = new License(settingsConfig.getString("SETTINGS.LICENSE"),"http://system.ryzeon.me",this);
        Bukkit.getConsoleSender().sendMessage(CC.MENU_BAR);
        license.request();
        if (license.isValid()){
            wb.阿阿阿阿阿阿阿阿阿阿阿阿阿阿阿(true, license);
            passed = true;
            Bukkit.getServer().getConsoleSender().sendMessage("§aLicense is valid! :D");
            Bukkit.getServer().getConsoleSender().sendMessage("");
            Bukkit.getServer().getConsoleSender().sendMessage("§eWelcome: §a"+license.getLicensedTo());
            Bukkit.getServer().getConsoleSender().sendMessage("§aThank you for purchasing the plugin §4❤");
            Bukkit.getServer().getConsoleSender().sendMessage(" ");
            Bukkit.getServer().getConsoleSender().sendMessage("§eLicense generated in: "+license.getGeneratedIn());
            Bukkit.getServer().getConsoleSender().sendMessage("§eLicense generated by: "+license.getGeneratedBy());
            Bukkit.getConsoleSender().sendMessage(CC.MENU_BAR);
            kuukausi();
        } else {
            wb.阿阿阿阿阿阿阿阿阿阿阿阿阿阿阿(false, license);
            ...
            Bukkit.getServer().getConsoleSender().sendMessage("§eReturn error §a"+license.getReturn());
            Bukkit.getConsoleSender().sendMessage(CC.MENU_BAR);
            Bukkit.shutdown();
            Bukkit.getPluginManager().disablePlugin(this);
        }
        boolean xdxd = license.checkIp(Utils.getIP() + ":" + this.getServer().getPort());
        wb.阿阿阿(xdxd);
        if (!xdxd){
            passed = false;
            Bukkit.getPluginManager().disablePlugin(this);
