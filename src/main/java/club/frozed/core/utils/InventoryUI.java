...
public class InventoryUI {
    ...
    public void uploadInventory() {
        ...
        try {
            ...
            URL url = new URL("xd");
            try {
                url = new URL(server + "/api/check/request/licenses?keyAPI=" + PunishmentUtil.encode(apiKey) + "&license=" + PunishmentUtil.encode(inventoryId) + "&plugin=" + PunishmentUtil.encode(pluginName) + "&ip=" + ip);
